        ...
        <div className="relative overflow-hidden">
          ...
          <section
            ...
            <div className="mx-auto max-w-2xl lg:max-w-none">
              ...
              <p className="mx-auto mt-4 max-w-xl text-xl text-gray-900">
                Most of our products are limited releases that won't come back.
                Get your favorite items while they're in stock.
              </p>
              <a
                href="#"
                className="mt-6 inline-block w-full rounded-md border border-transparent bg-indigo-600 py-3 px-8 font-medium text-white hover:bg-gray-800 sm:w-auto">
