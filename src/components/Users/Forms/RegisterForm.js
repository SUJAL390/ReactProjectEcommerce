              ...
              <div className=" text-center">
                ...
                <form onSubmit={onSubmitHandler}>
                  ...
                  <input
                    ...
                    value={password}
                    onChange={onChangeHandler}
                    className="w-full  px-12 pt-6 border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md"
                    type="password"
                  ...
                  {loading ? (
                    ...
                    <button className=" mb-4 md:mt-16 bg-blue-800 hover:bg-blue-900 text-white font-bold font-heading py-3 px-8 rounded-md uppercase">
                      Register
                    </button>
                  )}
                </form>
